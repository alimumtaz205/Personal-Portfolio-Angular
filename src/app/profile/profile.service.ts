...
export class ProfileService {
  ...
  about = "Software development is not only my profession, it is my passion and that passion keeps me alive."
  resumeurl = "https://drive.google.com/file/d/13F70BVnOUfTJSFsXvxRlBmGVAXhuiIrS/view?usp=sharing"
